CREATE SEQUENCE books___id___seq;
...
ALTER TABLE books ALTER COLUMN id SET DEFAULT nextval('books___id___seq'::regclass);

ALTER TABLE books ALTER COLUMN run__id SET NOT NULL;
